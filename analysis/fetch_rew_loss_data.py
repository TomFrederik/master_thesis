...
ours_dir = f"./data/dense/{OURS_JOB_ID}/{LOSS}"
...
if not os.path.exists(ours_dir):
    ...
    ours_mean_std_per_setting = compute_mean_std_per_setting(fetch_loss_list_per_setting(api, OURS_JOB_ID, NUM_SETTINGS, NUM_SEEDS, OURS_PROJ, LOSS, ENT, skip=True))
