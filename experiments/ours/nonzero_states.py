...
def main(train_args):
    ...
    run_args.update({
        "wandb_id": f"setting_{setting_id}_seed_{run_args['seed']}_job_{job_id}",
    })
...
train_parser.add_argument('--hparam_file', type=str, default='../hparam_files/perc_dropout/8.json')
