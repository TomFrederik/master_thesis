...
from src.common.wrappers import (DeterministicEnvWrappper, MyFullWrapper,
                      NormalizeObservations, OneHotActionToIndex, OneHotObs,
                      StepWrapper)
...
def main(args):
    ...
    with wandb.init(project='Simple Crossing with Dreamer', config=config_dict):
        """training loop"""
        print('...training...')
        train_metrics = {}
